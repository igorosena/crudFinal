...
export class GnosisSafeProxyResolver extends BaseProxyResolver {
...
export class LegacyUpgradeableProxyResolver extends BaseProxyResolver {
    async resolve(provider, address) {
...
export class EIP1967ProxyResolver extends BaseProxyResolver {
    async resolve(provider, address) {
...
export class ZeppelinOSProxyResolver extends BaseProxyResolver {
    async resolve(provider, address) {
        return addressFromPadded(await provider.getStorageAt(address, slots.ZEPPELINOS_IMPL));
    }
}
export class PROXIABLEProxyResolver extends BaseProxyResolver {
    async resolve(provider, address) {
...
export class SequenceWalletProxyResolver extends BaseProxyResolver {
    async resolve(provider, address) {
...
// Example: EIP-1167
export class FixedProxyResolver extends BaseProxyResolver {
    resolvedAddress;
